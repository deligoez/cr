...
var crossRoundReaders = map[string]string{
	...
	"internal/cli/recordids.go: refuseHeldIDs": "§6.1 makes a record id stable for the life of the pull " +
		...
		"is held still.",
	"internal/note/answer.go: holdsRecord": "§3.6.2 files an answer against a record the pull request " +
		"holds, and §9.3.5 exempts the context store from round scoping, so a question an earlier round's " +
		"`stale` record asked is still one an answer may name.",
