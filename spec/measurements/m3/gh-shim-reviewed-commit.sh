#!/bin/sh
# Measurement 3, run B: the pull request as its reviewer saw it.
#
...
# harness recorded.
M3=/private/tmp/claude-501/-Users-deligoez-Developer-deligoez-projects-cr/ab43de41-7948-4a07-bc9b-b5622c5ddeda/scratchpad/measure-3
LOG=$M3/ghb.log
REAL=/opt/homebrew/bin/gh
HEAD=$(sed -n 1p "$M3/run-b-commits.txt")
BASE=$(sed -n 2p "$M3/run-b-commits.txt")
