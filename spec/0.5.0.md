# cr v0.5.0 — The Conversation

Fifth release. Closes the loop. Every release through v0.4 ended at posting: cr
oriented, reviewed across four axes, proved findings with experiments, drafted,
...
carried into the next round unchanged. That is the fourth exit and it is not a
transition: standing still is what a concern does until somebody settles it.
